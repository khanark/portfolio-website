...
const stickyNavigationObserver = new IntersectionObserver(
  (entries) => {
    const techstackSection = entries[0]

    if (techstackSection.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  stickyNavigationObserver.observe(document.querySelector('.techstack'))
